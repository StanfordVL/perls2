...
To create a new project with perls2, look at the [project templates](https://github.com/StanfordVL/perls2/tree/master/examples/project_template). This template folder includes default config files that can be adapted for your project.
