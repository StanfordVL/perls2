...
from perls2.redis_interfaces import RedisInterface
...
class ROSCameraInterface(object):
    ...
    def _rgb_callback(self, rgb):
        ...
        encoded_rgb = convert_frame_to_encoded_bytes(self._rgb)
...
if __name__ == '__main__':
    ...
    camera = ROSCameraInterface(host="127.0.0.1", port=6379, password=None, 
