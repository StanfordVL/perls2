...
parser.add_argument('--publish_rate', metavar='f', type=int, default=800, help="rate at which sawyer should publish joint state")
...
pub = rospy.Publisher('/robot/joint_state_publish_rate', Int32)
