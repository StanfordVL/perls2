...
def find_next_joint(root, current_link, next_joint_name):
    ...
    Args:
        current_link: The current URDF link.
        next_joint_name: The name of the next joint.
    """
    has_next = False
    next_joint = None
    search_by_name = True
...
def find_next_link(root, current_joint, next_link_name):
    ...
    Args:
        current_joint: The current URDF joint.
        next_link_name: The name of the next link.
    """
    has_next = False
    next_link = None
