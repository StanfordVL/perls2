...
def inverse_kinematic_optimization(chain,
    ...
    Args:
        chain: The chain used for the Inverse kinematics.
        target: The desired target.
        initial_positions: The initial pose of your chain.
        max_iter: Maximum number of iterations for the optimisation algorithm.
    """
