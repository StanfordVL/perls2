...
class BulletArena(Arena):
    ...
    def view_matrix_to_extrinsic(self):
        L = np.asarray(self.camera_target_pos) - np.asarray(self.camera_eye_pos)
    ...
    def random_view_matrix(self):
        ...
        random_view_matrix =  pybullet.computeViewMatrix(
                cameraEyePosition=self.randomize_param(self._rand_camera_extrin_cfg['eye_position']) ,
                cameraTargetPosition=self.randomize_param(self._rand_camera_extrin_cfg['target_position']),
                cameraUpVector=self.camera_up_vector)
    ...
    def random_projection_matrix(self):
        ...
        rand_near_plane = self.randomize_param(self._rand_camera_intrin_cfg['near_plane'])
        rand_far_plane = self.randomize_param(self._rand_camera_intrin_cfg['far_plane'])
