...
class Arena:
    ...
    def __init__(self,
        ...
        self._rand_camera_intrin_cfg = self.config['sensor']['camera']['random']['intrinsics']
        self._rand_camera_extrin_cfg = self.config['sensor']['camera']['random']['extrinsics']
    ...
    def randomize_param(self, config_key):
        """ Randomize parameter according to bounds found in config file
            ...
            NOTE: bounds must be defined in config file as keys 'upper' and 'lower'
