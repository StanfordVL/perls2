        ...
        if (self.robot_interface.controlType == 'EEImpedance' or 
           (self.robot_interface.controlType == 'EEPosture')):
            ...
            if self.test_fn == 'set_ee_pose':
                self.robot_interface.set_ee_pose(delta=None, set_pos=action[:3], set_ori=action[3:])
            if self.test_fn == 'move_ee_delta':
                self.robot_interface.move_ee_delta(delta=action, set_pos=None, set_ori=None)
